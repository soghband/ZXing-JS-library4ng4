...
describe('BitVector', function () {
    ...
    it('testAppendBitVector', function () {
        var v1 = new BitArray_1.default();
        v1.appendBits(0xbe, 8);
        var v2 = new BitArray_1.default();
...
//# sourceMappingURL=BitVector.spec.js.map