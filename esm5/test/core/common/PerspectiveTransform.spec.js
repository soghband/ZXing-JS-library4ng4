...
describe('PerspectiveTransform', function () {
    ...
    it('testSquareToQuadrilateral', function () {
        var pt = PerspectiveTransform_1.default.squareToQuadrilateral(2.0, 3.0, 10.0, 4.0, 16.0, 15.0, 4.0, 9.0);
    ...
    it('testQuadrilateralToQuadrilateral', function () {
        var pt = PerspectiveTransform_1.default.quadrilateralToQuadrilateral(2.0, 3.0, 10.0, 4.0, 16.0, 15.0, 4.0, 9.0, 103.0, 110.0, 300.0, 120.0, 290.0, 270.0, 150.0, 280.0);
    ...
    function assertPointEquals(expectedX /*float*/, expectedY /*float*/, sourceX /*float*/, sourceY /*float*/, pt) {
        var points = Float32Array.from([sourceX, sourceY]);
...
//# sourceMappingURL=PerspectiveTransform.spec.js.map