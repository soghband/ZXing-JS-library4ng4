...
describe('ReedSolomon', function () {
    ...
    it('testDataMatrix 1 - real life test case', function () {
        testEncodeDecode(GenericGF_1.default.DATA_MATRIX_FIELD_256, Int32Array.from([142, 164, 186]), Int32Array.from([114, 25, 5, 88, 102]));
    });
    it('testDataMatrix 2 - real life test case', function () {
        testEncodeDecode(GenericGF_1.default.DATA_MATRIX_FIELD_256, Int32Array.from([
    ...
    it('testDataMatrix 3.1 - synthetic test cases', function () {
        testEncodeDecodeRandom(GenericGF_1.default.DATA_MATRIX_FIELD_256, 10, 240);
    });
    it('testDataMatrix 3.2 - synthetic test cases', function () {
        testEncodeDecodeRandom(GenericGF_1.default.DATA_MATRIX_FIELD_256, 128, 127);
    });
    it('testDataMatrix 3.3 - synthetic test cases', function () {
        testEncodeDecodeRandom(GenericGF_1.default.DATA_MATRIX_FIELD_256, 220, 35);
    });
    it('testQRCode 1 - from example given in ISO 18004, Annex I', function () {
        // Test case from example given in ISO 18004, Annex I
        testEncodeDecode(GenericGF_1.default.QR_CODE_FIELD_256, Int32Array.from([
    ...
    it('testQRCode 2 - real life test case', function () {
        testEncodeDecode(GenericGF_1.default.QR_CODE_FIELD_256, Int32Array.from([
    ...
    it('testQRCode 3.1 - synthetic test cases', function () {
        testEncodeDecodeRandom(GenericGF_1.default.QR_CODE_FIELD_256, 10, 240);
    });
    it('testQRCode 3.2 - synthetic test cases', function () {
        testEncodeDecodeRandom(GenericGF_1.default.QR_CODE_FIELD_256, 128, 127);
    });
    it('testQRCode 3.3 - synthetic test cases', function () {
        testEncodeDecodeRandom(GenericGF_1.default.QR_CODE_FIELD_256, 220, 35);
    });
    it('testAztec 1 - real life test case', function () {
        testEncodeDecode(GenericGF_1.default.AZTEC_PARAM, Int32Array.from([0x5, 0x6]), Int32Array.from([0x3, 0x2, 0xB, 0xB, 0x7]));
    });
    it('testAztec 2 - real life test case', function () {
        testEncodeDecode(GenericGF_1.default.AZTEC_PARAM, Int32Array.from([0x0, 0x0, 0x0, 0x9]), Int32Array.from([0xA, 0xD, 0x8, 0x6, 0x5, 0x6]));
    });
    it('testAztec 3 - real life test case', function () {
        testEncodeDecode(GenericGF_1.default.AZTEC_PARAM, Int32Array.from([0x2, 0x8, 0x8, 0x7]), Int32Array.from([0xE, 0xC, 0xA, 0x9, 0x6, 0x8]));
    });
    it('testAztec 4 - real life test case', function () {
        testEncodeDecode(GenericGF_1.default.AZTEC_DATA_6, Int32Array.from([0x9, 0x32, 0x1, 0x29, 0x2F, 0x2, 0x27, 0x25, 0x1, 0x1B]), Int32Array.from([0x2C, 0x2, 0xD, 0xD, 0xA, 0x16, 0x28, 0x9, 0x22, 0xA, 0x14]));
    });
    it('testAztec 5 - real life test case', function () {
        testEncodeDecode(GenericGF_1.default.AZTEC_DATA_8, Int32Array.from([
    ...
    it('testAztec 6 - real life test case', function () {
        testEncodeDecode(GenericGF_1.default.AZTEC_DATA_10, Int32Array.from([
    ...
    it('testAztec 7 - real life test case', function () {
        testEncodeDecode(GenericGF_1.default.AZTEC_DATA_12, Int32Array.from([
    ...
    it('testAztec 8.1 - synthetic test cases (compact mode message)', function () {
        testEncodeDecodeRandom(GenericGF_1.default.AZTEC_PARAM, 2, 5);
    });
    it('testAztec 8.2 - synthetic test cases (full mode message)', function () {
        testEncodeDecodeRandom(GenericGF_1.default.AZTEC_PARAM, 4, 6);
    });
    it('testAztec 8.3 - synthetic test cases', function () {
        testEncodeDecodeRandom(GenericGF_1.default.AZTEC_DATA_6, 10, 7);
    });
    it('testAztec 8.4 - synthetic test cases', function () {
        testEncodeDecodeRandom(GenericGF_1.default.AZTEC_DATA_6, 20, 12);
    });
    it('testAztec 8.5 - synthetic test cases', function () {
        testEncodeDecodeRandom(GenericGF_1.default.AZTEC_DATA_8, 20, 11);
    });
    it('testAztec 8.6 - synthetic test cases', function () {
        testEncodeDecodeRandom(GenericGF_1.default.AZTEC_DATA_8, 128, 127);
    });
    it('testAztec 8.7 - synthetic test cases', function () {
        testEncodeDecodeRandom(GenericGF_1.default.AZTEC_DATA_10, 128, 128);
    });
    it('testAztec 8.8 - synthetic test cases', function () {
        testEncodeDecodeRandom(GenericGF_1.default.AZTEC_DATA_10, 768, 255);
    });
    it('testAztec 8.9 - synthetic test cases', function () {
        testEncodeDecodeRandom(GenericGF_1.default.AZTEC_DATA_12, 3072, 1023);
    });
    function corrupt(received, howMany /*int*/, random, max /*int*/) {
        var corrupted = new Map(); // (received.length)
        for (var j = 0; j < howMany; j++) {
            var location_1 = random.next(received.length);
            var value = random.next(max);
            if (corrupted.get(location_1) === true || received[location_1] === value) {
                j--;
            }
            else {
                corrupted.set(location_1, true);
                received[location_1] = value;
            }
        }
    }
    function testEncodeDecodeRandom(field, dataSize /*int*/, ecSize /*int*/) {
        ...
        var encoder = new ReedSolomonEncoder_1.default(field);
        var message = new Int32Array(dataSize + ecSize);
        var dataWords = new Int32Array(dataSize); /*Int32Array(dataSize)*/
        var ecWords = new Int32Array(ecSize); /*Int32Array(ecSize)*/
        ...
        for (var i = 0; i < iterations; i++) {
            ...
            // generate ECC words
            System_1.default.arraycopy(dataWords, 0, message, 0, dataWords.length);
            encoder.encode(message, ecWords.length);
            System_1.default.arraycopy(message, dataSize, ecWords, 0, ecSize);
    ...
    function testEncoder(field, dataWords, ecWords) {
        ...
        System_1.default.arraycopy(dataWords, 0, messageExpected, 0, dataWords.length);
        System_1.default.arraycopy(ecWords, 0, messageExpected, dataWords.length, ecWords.length);
        System_1.default.arraycopy(dataWords, 0, message, 0, dataWords.length);
        encoder.encode(message, ecWords.length);
    ...
    function testDecoder(field, dataWords, ecWords) {
        var decoder = new ReedSolomonDecoder_1.default(field);
        var message = new Int32Array(dataWords.length + ecWords.length);
        var maxErrors = Math.floor(ecWords.length / 2);
        var random = getPseudoRandom();
        ...
        for (var j = 0; j < iterations; j++) {
            for (var i = 0; i < ecWords.length; i++) {
                ...
                System_1.default.arraycopy(dataWords, 0, message, 0, dataWords.length);
                System_1.default.arraycopy(ecWords, 0, message, dataWords.length, ecWords.length);
                ...
                try {
                    ...
                    assert.strictEqual(i > maxErrors, true, 'Decode in ' + field + ' (' + dataWords.length + ',' + ecWords.length + ') failed at ' + i + ' errors: ' + e);
                    // else stop
                    break;
                }
                if (i < maxErrors) {
                    assertDataEquals(message, dataWords, 'Decode in ' + field + ' (' + dataWords.length + ',' + ecWords.length + ') failed at ' + i + ' errors');
                }
            }
        }
    }
    function assertDataEquals(received, expected, message) {
    ...
    function getPseudoRandom() {
        return new Random_1.default('0xDEADBEEF');
    }
});
//# sourceMappingURL=ReedSolomon.spec.js.map