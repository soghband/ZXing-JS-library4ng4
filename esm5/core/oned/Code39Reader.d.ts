...
export default class Code39Reader extends OneDReader {
    ...
    private static findAsteriskPattern(row, counters);
    private static toNarrowWidePattern(counters);
    private static patternToChar(pattern);
    private static decodeExtended(encoded);
}
